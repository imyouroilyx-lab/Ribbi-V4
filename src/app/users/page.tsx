...
import NavLayout from '@/components/NavLayout'; // เพิ่มการ Import
import { 
  Search, 
  UserPlus, 
  MoreVertical, 
...
export default function UsersPage() {
  ...
  // แสดง Loading ภายใต้ NavLayout เพื่อความสวยงาม
  if (loading) {
    return (
      <NavLayout>
  ...
  return (
    <NavLayout>
      <div className="max-w-6xl mx-auto px-4 py-6 font-sans text-slate-900">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-800">จัดการสมาชิก</h1>
